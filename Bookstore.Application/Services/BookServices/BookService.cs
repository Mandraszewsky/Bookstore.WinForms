using Bookstore.Application.Interfaces.BookInterfaces;
...
public class BookService : IBookService
{
    public List<Book> GetBooksAsync()
    {
        ...
        string querySQL = "SELECT BookId, ISBN, Title, Description, PagesNumber, Quantity, PublicationDate, FirstName, LastName FROM GetBooksWithAuthorsView";
